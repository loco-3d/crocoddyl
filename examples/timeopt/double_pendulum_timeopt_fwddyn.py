...
# Creating the running and terminal models. Time optimization is attached to the
# running model; the terminal model remains state-only, as in terminal action
# models.
