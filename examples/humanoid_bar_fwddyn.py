...
problem = humanoid.createMonkeyOneBarProblem(
...
# solver.solve(xs, us, maxiter=200, is_feasible=False)
...
print("   LH position:", LH_grasp_list[-1].translation)
print("   LH quaternion:", pinocchio.Quaternion(LH_grasp_list[-1].rotation).coeffs())
print("Terminal end-effector pose:")
print("   RH position:", RH_Mterm[:3])
print("   RH quaternion:", RH_Mterm[3:7])
print("   LH position:", LH_Mterm[:3])
print("   LH quaternion:", LH_Mterm[3:7])
