...
class GepettoDisplay(DisplayAbstract):
    ...
    def _setConeMu(self, coneName, mu):
        ...
        if mu != current_mu:
            ...
            self.robot.viewer.gui.deleteNode(coneGroup + "/lines/0", True)
            self.robot.viewer.gui.deleteNode(coneGroup + "/lines/1", True)
            self.robot.viewer.gui.deleteNode(coneGroup + "/lines/2", True)
            self.robot.viewer.gui.deleteNode(coneGroup + "/lines/3", True)
            self.robot.viewer.gui.deleteNode(coneGroup + "/lines", True)
            self.robot.viewer.gui.deleteNode(coneGroup + "/cone", True)
