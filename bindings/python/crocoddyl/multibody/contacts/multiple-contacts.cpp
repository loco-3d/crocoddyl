...
#define CROCODDYL_CONTACT_ITEM_PYTHON_BINDINGS(Scalar)                       \
  typedef ContactItemTpl<Scalar> Model;                                      \
  typedef Model::ContactModelAbstract ContactModel;                          \
  typedef std::shared_ptr<Model> ContactItemPtr;                             \
  StdMapPythonVisitor<                                                       \
...
void exposeContactMultiple() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONTACT_ITEM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONTACT_MODEL_MULTIPLE_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONTACT_DATA_MULTIPLE_PYTHON_BINDINGS)
}
