...
void exposeContact3D() {
  bp::class_<ContactModel3D, bp::bases<ContactModelAbstract>>(
      ...
      bp::init<boost::shared_ptr<StateMultibody>, FrameTranslation, int,
          ...
          ":param gains: gains of the contact model (default np.matrix([ "
          "[0.],[0.] ]))"))
      ...
      .def("createData", &ContactModel3D::createData,
           ...
           ":return contact data.")
      .add_property("xref",
                    bp::make_function(&ContactModel3D::get_xref,
  ...
  bp::class_<ContactData3D, bp::bases<ContactDataAbstract>>(
      ...
      .add_property(
          "a",
          bp::make_getter(&ContactData3D::a,
                          bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "oRf",
          bp::make_getter(&ContactData3D::oRf,
                          bp::return_internal_reference<>()),
