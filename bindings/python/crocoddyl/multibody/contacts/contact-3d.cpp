...
#pragma GCC diagnostic pop
  ...
  bp::class_<ContactData3D, bp::bases<ContactDataAbstract> >(
      ...
      .add_property("a0_local", bp::make_getter(&ContactData3D::a0_local, bp::return_internal_reference<>()),
                    bp::make_setter(&ContactData3D::a0_local), "desired local contact acceleration")
      .add_property("dp", bp::make_getter(&ContactData3D::dp, bp::return_internal_reference<>()),
