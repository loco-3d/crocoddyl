...
void exposeFrames() {
  bp::class_<FrameTranslation>(
      ...
      bp::init<FrameIndex, Eigen::Vector3d>(
          bp::args("self", "id", "translation"),
          "Initialize the frame translation.\n\n"
          ":param id: frame ID\n"
          ":param translation: Frame translation w.r.t. the origin"))
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame translation."))
      .def_readwrite("id", &FrameTranslation::id, "frame ID")
      .add_property("translation",
                    bp::make_getter(&FrameTranslation::translation,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&FrameTranslation::translation),
                    "frame translation")
      .add_property(
          "frame",
          bp::make_getter(
              &FrameTranslation::id,
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FrameTranslation::id,
      ...
      .add_property(
          ...
          bp::make_setter(&FrameTranslation::translation,
                          deprecated<>("Deprecated. Use translation.")),
          "frame translation")
  ...
  bp::class_<FrameRotation>(
      ...
      bp::init<FrameIndex, Eigen::Matrix3d>(
          bp::args("self", "id", "rotation"),
          "Initialize the frame rotation.\n\n"
          ":param id: frame ID\n"
          ":param rotation: Frame rotation w.r.t. the origin"))
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame rotation."))
      ...
      .add_property(
          ...
          bp::make_getter(
              ...
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FrameRotation::id,
                          deprecated<>("Deprecated. Use id")),
          "frame ID")
      .add_property("oRf",
                    bp::make_getter(&FrameRotation::rotation,
                    ...
                    bp::make_setter(&FrameRotation::rotation,
                                    deprecated<>("Deprecated. Use rotation.")),
                    "frame rotation")
  ...
  bp::class_<FramePlacement>(
      ...
      .add_property(
          ...
          bp::make_getter(
              ...
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FramePlacement::id,
                          deprecated<>("Deprecated. Use id")),
          "frame ID")
      .add_property("oMf",
                    bp::make_getter(&FramePlacement::placement,
                    ...
                    bp::make_setter(&FramePlacement::placement,
                                    deprecated<>("Deprecated. Use placement.")),
                    "frame placement")
  ...
  bp::class_<FrameMotion>(
      ...
      bp::init<FrameIndex, pinocchio::Motion,
      ...
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame motion."))
      ...
      .add_property(
          ...
          bp::make_getter(
              ...
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FrameMotion::id, deprecated<>("Deprecated. Use id")),
          "frame ID")
      .add_property("oMf",
                    bp::make_getter(&FrameMotion::motion,
                                    deprecated<bp::return_internal_reference<>>(
                                        "Deprecated. Use motion.")),
                    bp::make_setter(&FrameMotion::motion,
                                    deprecated<>("Deprecated. Use motion.")),
                    "frame motion")
  ...
  bp::class_<FrameForce>("FrameForce",
                         ...
                         bp::init<FrameIndex, pinocchio::Force>(
                             bp::args("self", "id", "force"),
                             "Initialize the frame force.\n\n"
                             ":param id: frame ID\n"
                             ":param force: Frame force w.r.t. the origin"))
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame force."))
      .def_readwrite("id", &FrameForce::id, "frame ID")
      .add_property("force",
                    bp::make_getter(&FrameForce::force,
                                    bp::return_internal_reference<>()),
      ...
      .add_property(
          ...
          bp::make_getter(
              ...
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FrameForce::id, deprecated<>("Deprecated. Use id")),
          "frame ID")
      .add_property("oFf",
                    bp::make_getter(&FrameForce::force,
                                    deprecated<bp::return_internal_reference<>>(
                                        "Deprecated. Use force.")),
                    bp::make_setter(&FrameForce::force,
                                    deprecated<>("Deprecated. Use force.")),
                    "frame force")
  ...
  bp::class_<FrameFrictionCone>(
      ...
      bp::init<FrameIndex, FrictionCone>(
          bp::args("self", "id", "cone"),
          "Initialize the frame friction cone.\n\n"
          ":param id: frame ID\n"
          ":param cone: Frame friction cone w.r.t. the origin"))
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame friction cone."))
      .def_readwrite("id", &FrameFrictionCone::id, "frame ID")
      .add_property("cone",
                    bp::make_getter(&FrameFrictionCone::cone,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&FrameFrictionCone::cone),
                    "frame friction cone")
      .add_property(
          "frame",
          bp::make_getter(
              &FrameFrictionCone::id,
              deprecated<bp::return_value_policy<bp::copy_non_const_reference>>(
                  "Deprecated. Use id")),
          bp::make_setter(&FrameFrictionCone::id,
                          deprecated<>("Deprecated. Use id")),
          "frame ID")
      .add_property("oFf",
                    bp::make_getter(&FrameFrictionCone::cone,
                                    deprecated<bp::return_internal_reference<>>(
                                        "Deprecated. Use cone.")),
                    bp::make_setter(&FrameFrictionCone::cone,
                                    deprecated<>("Deprecated. Use cone.")),
                    "frame friction cone")
  ...
  bp::class_<FrameWrenchCone>(
      ...
      bp::init<FrameIndex, WrenchCone>(
          bp::args("self", "id", "cone"),
          "Initialize the frame wrench cone.\n\n"
          ":param id: frame ID\n"
          ":param cone: Frame wrench cone w.r.t. the origin"))
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame wrench cone."))
      .def_readwrite("id", &FrameWrenchCone::id, "frame ID")
      .add_property("cone",
                    bp::make_getter(&FrameWrenchCone::cone,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&FrameWrenchCone::cone),
                    "frame wrench cone")
  ...
  bp::class_<FrameCoPSupport>(
      "FrameCoPSupport",
      "Frame foot geometry.\n\n"
      "It defines the ID of the contact frame and the geometry of the contact "
      "surface",
      ...
      .def(bp::init<>(bp::args("self"),
                      "Default initialization of the frame CoP support."))
      .def("update_A", &FrameCoPSupport::update_A,
           "update the matrix that defines the support region")
      .add_property(
          "id",
      ...
      .add_property("box",
                    bp::make_function(&FrameCoPSupport::get_box,
                                      bp::return_internal_reference<>()),
                    bp::make_function(&FrameCoPSupport::set_box),
      ...
      .add_property(
          ...
          bp::make_function(&FrameCoPSupport::get_box,
                            deprecated<bp::return_internal_reference<>>(
                                "Deprecated. Use box.")),
          bp::make_function(&FrameCoPSupport::set_box,
                            deprecated<>("Deprecated. Use box.")),
          "box size used to define the sole")
      //   .add_property("A", bp::make_function(&FrameCoPSupport::get_A,
      //   bp::return_internal_reference<>()),
      //                 "inequality matrix") // TODO(cmastalli) we cannot
      //                 expose due to a compilation error with Matrix46
      .add_property(
          "frame",
          bp::make_function(
              &FrameCoPSupport::get_id,
              deprecated<bp::return_value_policy<bp::return_by_value>>(
                  "Deprecated. Use id.")),
          bp::make_function(&FrameCoPSupport::set_id,
                            deprecated<>("Deprecated. Use id.")),
          "frame ID")
      .def(PrintableVisitor<FrameCoPSupport>());

  pinocchio::python::StdAlignedVectorPythonVisitor<
      FramePlacement, true>::expose("StdVec_FramePlacement");

  pinocchio::python::StdAlignedVectorPythonVisitor<FrameRotation, true>::expose(
      "StdVec_FrameRotation");

  pinocchio::python::StdAlignedVectorPythonVisitor<
      FrameTranslation, true>::expose("StdVec_FrameTranslation");
  pinocchio::python::StdAlignedVectorPythonVisitor<FrameForce, true>::expose(
      "StdVec_FrameForce");

  pinocchio::python::StdAlignedVectorPythonVisitor<FrameMotion, true>::expose(
      "StdVec_FrameMotion");
}
