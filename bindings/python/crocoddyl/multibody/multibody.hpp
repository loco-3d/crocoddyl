...
void exposeJointDynamicsAbstract();
void exposeJointDynamicsIdentity();
void exposeJointDynamicsFriction();
void exposeJointDynamicsThruster();
void exposeActuationMultibody();
void exposeActuationMultibodyParams();
void exposeInertialParametrizationAbstract();
void exposeLogCholeskyParametrization();
void exposeExpEigenValueParametrization();
...
void exposeImplicitConstraintAbstract();
void exposeContact();
void exposeKinematicLoop();
void exposeImplicitConstraintMultiple();
void exposeContactMultiple();
void exposeImpulseMultiple();
void exposeDataCollectorMultibody();
void exposeDataCollectorContacts();
void exposeDataCollectorImplicitConstraints();
void exposeDataCollectorImpulses();
void exposeDynamicsConstrainedForward();
void exposeDynamicsConstrainedInverse();
void exposeDynamicsImpulseForward();
