...
void exposeFrictionCone() {
  bp::class_<FrictionCone>("FrictionCone", "Model of the friction cone as lb <= Af <= ub",
      ...
      .add_property("mu", bp::make_function(&FrictionCone::get_mu, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&FrictionCone::set_mu, bp::return_internal_reference<>()),
      ...
      .add_property("inner_appr",
                    ...
                    bp::make_function(&FrictionCone::set_inner_appr, bp::return_internal_reference<>()),
      ...
      .add_property("min_nforce",
                    ...
                    bp::make_function(&FrictionCone::set_min_nforce, bp::return_internal_reference<>()),
      ...
      .add_property("max_nforce",
                    ...
                    bp::make_function(&FrictionCone::set_max_nforce, bp::return_internal_reference<>()),
