...
void exposeFrictionCone() {
  bp::class_<FrictionCone>(
      ...
      bp::init<Eigen::Vector3d, double,
               bp::optional<std::size_t, bool, double, double>>(
          bp::args("self", "normal", "mu", "nf", "inner_appr", "min_nforce",
                   "max_nforce"),
      ...
      .def("update", &FrictionCone::update,
           bp::args("self", "normal", "mu", "inner_appr", "min_nforce",
                    "max_nforce"),
      ...
      .add_property("nsurf",
                    bp::make_function(&FrictionCone::get_nsurf,
                                      bp::return_internal_reference<>()),
                    bp::make_function(&FrictionCone::set_nsurf),
                    "normal vector")
      .add_property(
          "mu",
          bp::make_function(&FrictionCone::get_mu,
