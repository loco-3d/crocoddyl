...
#define CROCODDYL_THRUSTER_BINDINGS(Scalar)                                    \
  typedef ThrusterTpl<Scalar> Model;                                           \
  typedef typename pinocchio::SE3Tpl<Scalar> SE3;                              \
  bp::register_ptr_to_python<std::shared_ptr<Model>>();                        \
  StdVectorPythonVisitor<std::vector<Model>, true>::expose("StdVec_Thruster"); \
  bp::class_<Model>(                                                           \
...
#define CROCODDYL_ACTUATION_MODEL_FLOATINGBASE_THRUSTERS_PYTHON_BINDINGS(   \
  ...
  typedef ThrusterTpl<Scalar> Thrusters;                                    \
  ...
  bp::class_<Model, bp::bases<ModelBase>>(                                  \
      ...
      bp::init<std::shared_ptr<StateMultibody>, std::vector<Thrusters>>(    \
...
void exposeActuationFloatingBaseThruster() {
  ...
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_THRUSTER_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(
      CROCODDYL_ACTUATION_MODEL_FLOATINGBASE_THRUSTERS_PYTHON_BINDINGS)
}
