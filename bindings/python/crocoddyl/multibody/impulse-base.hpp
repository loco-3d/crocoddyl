...
public:
  ImpulseModelAbstract_wrap(boost::shared_ptr<StateMultibody> state, int ni)
      : ImpulseModelAbstract(state, ni) {}
  ...
  void updateForce(const boost::shared_ptr<ImpulseDataAbstract> &data,
    ...
    assert_pretty(static_cast<std::size_t>(force.size()) == ni_,
                  "force has wrong dimension");
    return bp::call<void>(this->get_override("updateForce").ptr(), data, force);
  }

  boost::shared_ptr<ImpulseDataAbstract>
  createData(pinocchio::DataTpl<Scalar> *const data) {
    if (boost::python::override createData = this->get_override("createData")) {
      return bp::call<boost::shared_ptr<ImpulseDataAbstract>>(createData.ptr(),
                                                              boost::ref(data));
    }
  ...
  boost::shared_ptr<ImpulseDataAbstract>
  default_createData(pinocchio::DataTpl<Scalar> *const data) {
