...
public:
  ContactModelAbstract_wrap(boost::shared_ptr<StateMultibody> state, int nc,
                            int nu)
      : ContactModelAbstract(state, nc, nu) {}
  ContactModelAbstract_wrap(boost::shared_ptr<StateMultibody> state, int nc)
      : ContactModelAbstract(state, nc) {}
  ...
  createData(pinocchio::DataTpl<Scalar> *const data) {
    if (boost::python::override createData = this->get_override("createData")) {
      return bp::call<boost::shared_ptr<ContactDataAbstract>>(createData.ptr(),
                                                              boost::ref(data));
    }
