...
void exposeContactAbstract() {
  ...
  bp::class_<ContactModelAbstract_wrap, boost::noncopyable>(
      ...
      .add_property(
          "nc",
          bp::make_function(&ContactModelAbstract_wrap::get_nc,
                            bp::return_value_policy<bp::return_by_value>()),
          "dimension of contact")
      .add_property(
          "nu",
          bp::make_function(&ContactModelAbstract_wrap::get_nu,
                            bp::return_value_policy<bp::return_by_value>()),
  ...
  bp::class_<ContactDataAbstract, boost::noncopyable>(
      ...
      .add_property("pinocchio",
                    bp::make_getter(&ContactDataAbstract::pinocchio,
                                    bp::return_internal_reference<>()),
                    "pinocchio data")
      .add_property(
          "jMf",
          bp::make_getter(&ContactDataAbstract::jMf,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&ContactDataAbstract::jMf),
      ...
      .add_property("Jc",
                    bp::make_getter(&ContactDataAbstract::Jc,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&ContactDataAbstract::Jc),
                    "contact Jacobian")
      .add_property("a0",
      ...
      .add_property("df_dx",
                    bp::make_getter(&ContactDataAbstract::df_dx,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&ContactDataAbstract::df_dx),
                    "Jacobian of the contact forces")
      .add_property("df_du",
                    bp::make_getter(&ContactDataAbstract::df_du,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&ContactDataAbstract::df_du),
                    "Jacobian of the contact forces")
      .def_readwrite("joint", &ContactDataAbstract::joint,
                     "joint index of the contact frame")
      .def_readwrite("frame", &ContactDataAbstract::frame,
                     "frame index of the contact frame")
      .def_readwrite(
          "f", &ContactDataAbstract::f,
          "external spatial force at the parent joint level. Note that we "
          "could compute the force at the "
