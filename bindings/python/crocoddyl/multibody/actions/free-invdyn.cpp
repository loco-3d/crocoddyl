  ...
  bp::scope().attr("no") = 0;
  {
    ...
    bp::scope model_outer =
        bp::class_<DifferentialActionModelFreeInvDynamics, bp::bases<DifferentialActionModelAbstract> >(
            ...
            .def("multiplyByFu", &DifferentialActionModelFreeInvDynamics::multiplyByFu, bp::args("self", "Fu", "A"),
            ...
            .def("multiplyFuTransposeBy", &DifferentialActionModelFreeInvDynamics::multiplyFuTransposeBy,
                 bp::args("self", "Fu", "A"),
