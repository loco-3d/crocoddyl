...
void exposeDifferentialActionFreeInvDynamics() {
  ...
  scope().attr("no") = 0;
  {
    ...
    bp::class_<ResidualModelRnea, bp::bases<ResidualModelAbstract> >(
        "ResidualModelRnea",
        "This residual function is defined as r = tau - rnea, where" bp::init<boost::shared_ptr<StateMultibody>,
                                                                              std::size_t>(
        ...
        .def<void (ResidualModelRnea::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                         const Eigen::Ref<const Eigen::VectorXd>&,
                                         const Eigen::Ref<const Eigen::VectorXd>&)>("calc", &ResidualModelRnea::calc,
