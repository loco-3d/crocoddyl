...
void exposeDifferentialActionFreeInvDynamics() {
  ...
  bp::scope().attr("no") = 0;
  {
    ...
    bp::class_<DifferentialActionModelFreeInvDynamics::ResidualModelActuation, bp::bases<ResidualModelAbstract>>(
        ...
        .def<void (DifferentialActionModelFreeInvDynamics::ResidualModelActuation::*)(
            const boost::shared_ptr<ResidualDataAbstract>&, const Eigen::Ref<const Eigen::VectorXd>&,
            const Eigen::Ref<const Eigen::VectorXd>&)>(
            "calc", &DifferentialActionModelFreeInvDynamics::ResidualModelActuation::calc,
            bp::args("self", "data", "x", "u"),
        ...
        .def<void (DifferentialActionModelFreeInvDynamics::ResidualModelActuation::*)(
            const boost::shared_ptr<ResidualDataAbstract>&, const Eigen::Ref<const Eigen::VectorXd>&,
            const Eigen::Ref<const Eigen::VectorXd>&)>(
            "calcDiff", &DifferentialActionModelFreeInvDynamics::ResidualModelActuation::calcDiff,
            bp::args("self", "data", "x", "u"),
        ...
        .def("createData", &DifferentialActionModelFreeInvDynamics::ResidualModelActuation::createData,
  ...
  bp::class_<DifferentialActionDataFreeInvDynamics::ResidualDataActuation, bp::bases<ResidualDataAbstract>>(
      "ResidualDataActuation", "Data for actuation residual.\n\n",
      bp::init<DifferentialActionModelFreeInvDynamics::ResidualModelActuation*, DataCollectorAbstract*>(
