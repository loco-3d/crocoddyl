...
#define CROCODDYL_IMPULSE_ITEM_PYTHON_BINDINGS(Scalar)                       \
  typedef ImpulseItemTpl<Scalar> Model;                                      \
  typedef Model::ImpulseModelAbstract ImpulseModel;                          \
  typedef std::shared_ptr<Model> ImpulseItemPtr;                             \
...
void exposeImpulseMultiple() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_IMPULSE_ITEM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_IMPULSE_MODEL_MULTIPLE_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_IMPULSE_DATA_MULTIPLE_PYTHON_BINDINGS)
}
