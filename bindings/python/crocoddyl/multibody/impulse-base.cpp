...
void exposeImpulseAbstract() {
  ...
  bp::class_<ImpulseModelAbstract_wrap, boost::noncopyable>(
      ...
      .add_property(
          "ni",
          bp::make_function(&ImpulseModelAbstract_wrap::get_ni,
                            bp::return_value_policy<bp::return_by_value>()),
  ...
  bp::class_<ImpulseDataAbstract, boost::noncopyable>(
      ...
      .add_property("pinocchio",
                    bp::make_getter(&ImpulseDataAbstract::pinocchio,
                                    bp::return_internal_reference<>()),
                    "pinocchio data")
      .add_property(
          "jMf",
          bp::make_getter(&ImpulseDataAbstract::jMf,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&ImpulseDataAbstract::jMf),
          "local frame placement of the impulse frame")
      .add_property("Jc",
                    bp::make_getter(&ImpulseDataAbstract::Jc,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&ImpulseDataAbstract::Jc),
                    "impulse Jacobian")
      .add_property("dv0_dq",
      ...
      .add_property("df_dx",
                    bp::make_getter(&ImpulseDataAbstract::df_dx,
                                    bp::return_internal_reference<>()),
                    bp::make_setter(&ImpulseDataAbstract::df_dx),
                    "Jacobian of the contact impulse")
      .def_readwrite("joint", &ImpulseDataAbstract::joint,
                     "joint index of the impulse frame")
      .def_readwrite("frame", &ImpulseDataAbstract::frame,
                     "frame index of the impulse frame")
