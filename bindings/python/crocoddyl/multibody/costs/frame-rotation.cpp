...
void exposeCostFrameRotation() {
  bp::class_<CostModelFrameRotation, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = R - Rref, with R "
      "and Rref as the current and reference "
      "frame rotations, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameRotation, int>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>,
                    boost::shared_ptr<ActivationModelAbstract>, FrameRotation>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameRotation>(
          ...
          ":param state: state of the multibody system\n"
          ":param Rref: reference frame rotation"))
      .def<void (CostModelFrameRotation::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelFrameRotation::calc,
      ...
      .def<void (CostModelFrameRotation::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelFrameRotation::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelFrameRotation::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelFrameRotation::createData,
      ...
      .add_property("reference",
                    &CostModelFrameRotation::get_reference<FrameRotation>,
                    &CostModelFrameRotation::set_reference<FrameRotation>,
  ...
  bp::class_<CostDataFrameRotation, bp::bases<CostDataAbstract>>(
      ...
      .add_property("r",
                    bp::make_getter(&CostDataFrameRotation::r,
                                    bp::return_internal_reference<>()),
                    "cost residual")
      .add_property("rRf",
                    bp::make_getter(&CostDataFrameRotation::rRf,
                                    bp::return_internal_reference<>()),
                    "rotation error of the frame")
      .add_property("J",
                    bp::make_getter(&CostDataFrameRotation::J,
                                    bp::return_internal_reference<>()),
                    "Jacobian at the error point")
      .add_property("rJf",
                    bp::make_getter(&CostDataFrameRotation::rJf,
                                    bp::return_internal_reference<>()),
                    "error Jacobian of the frame")
      .add_property("fJf",
                    bp::make_getter(&CostDataFrameRotation::fJf,
                                    bp::return_internal_reference<>()),
