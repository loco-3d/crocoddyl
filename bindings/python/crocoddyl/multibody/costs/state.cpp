...
void exposeCostState() {
  bp::class_<CostModelState, bp::bases<CostModelAbstract>>(
      ...
      .def(bp::init<boost::shared_ptr<StateAbstract>, int>(
          ...
          "Initialize the state cost model.\n\n"
          "We use ActivationModelQuad as a default activation model (i.e. "
          "a=0.5*||r||^2). The default reference state "
      ...
      .def<void (CostModelState::*)(const boost::shared_ptr<CostDataAbstract> &,
                                    ...
                                    const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelState::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelState::*)(const boost::shared_ptr<CostDataAbstract> &,
                                    const Eigen::Ref<const Eigen::VectorXd> &,
                                    const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelState::calcDiff,
      ...
      .def<void (CostModelState::*)(const boost::shared_ptr<CostDataAbstract> &,
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelState::createData,
           ...
           ":return cost data.")
      .add_property(
          "reference", &CostModelState::get_reference<Eigen::VectorXd>,
