...
void exposeCostContactFrictionCone() {
  bp::class_<CostModelContactFrictionCone, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = A*f, where A, f "
      "describe the linearized friction cone and "
      "the spatial force, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameFrictionCone,
               int>(bp::args("self", "state", "activation", "fref", "nu"),
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameFrictionCone>(
          ...
          ":param state: state of the multibody system\n"
          ":param fref: frame friction cone"))
      .def<void (CostModelContactFrictionCone::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelContactFrictionCone::calc,
      ...
      .def<void (CostModelContactFrictionCone::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelContactFrictionCone::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelContactFrictionCone::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelContactFrictionCone::createData,
      ...
      .add_property(
          "reference",
          &CostModelContactFrictionCone::get_reference<FrameFrictionCone>,
          &CostModelContactFrictionCone::set_reference<FrameFrictionCone>,
          "reference frame friction cone");
  ...
  bp::class_<CostDataContactFrictionCone, bp::bases<CostDataAbstract>>(
      ...
      .add_property("Arr_Ru",
                    bp::make_getter(&CostDataContactFrictionCone::Arr_Ru,
                                    bp::return_internal_reference<>()),
                    "Intermediate product of Arr (2nd deriv of Activation) "
                    "with Ru (deriv of residue)")
      .add_property(
          "contact",
          bp::make_getter(&CostDataContactFrictionCone::contact,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataContactFrictionCone::contact),
          "contact data associated with the current cost");
}
