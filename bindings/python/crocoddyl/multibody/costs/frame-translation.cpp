...
void exposeCostFrameTranslation() {
  bp::class_<CostModelFrameTranslation, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = t - tref, with t "
      "and tref as the current and reference "
      "frame translations, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameTranslation,
               int>(bp::args("self", "state", "activation", "xref", "nu"),
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameTranslation>(
          ...
          ":param state: state of the multibody system\n"
          ":param xref: reference frame translation"))
      .def<void (CostModelFrameTranslation::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelFrameTranslation::calc,
      ...
      .def<void (CostModelFrameTranslation::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelFrameTranslation::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelFrameTranslation::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelFrameTranslation::createData,
      ...
      .add_property("reference",
                    &CostModelFrameTranslation::get_reference<FrameTranslation>,
                    &CostModelFrameTranslation::set_reference<FrameTranslation>,
  ...
  bp::class_<CostDataFrameTranslation, bp::bases<CostDataAbstract>>(
      ...
      .add_property("J",
                    bp::make_getter(&CostDataFrameTranslation::J,
                                    bp::return_internal_reference<>()),
                    "Jacobian at the error point")
      .add_property("fJf",
                    bp::make_getter(&CostDataFrameTranslation::fJf,
                                    bp::return_internal_reference<>()),
