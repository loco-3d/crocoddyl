...
void exposeCostContactForce() {
  bp::class_<CostModelContactForce, bp::bases<CostModelAbstract>>(
      ...
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameForce, int>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameForce>(
          ...
          ":param fref: reference spatial contact force in the contact "
          "coordinates"))
      .def<void (CostModelContactForce::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelContactForce::calc,
      ...
      .def<void (CostModelContactForce::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelContactForce::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &CostModelContactForce::createData,
           ...
           ":return cost data.")
      .add_property(
          "reference", &CostModelContactForce::get_reference<FrameForce>,
  ...
  bp::class_<CostDataContactForce, bp::bases<CostDataAbstract>>(
      ...
      .add_property("Arr_Ru",
                    bp::make_getter(&CostDataContactForce::Arr_Ru,
                                    bp::return_internal_reference<>()),
                    "Intermediate product of Arr (2nd deriv of Activation) "
                    "with Ru (deriv of residue)")
      .add_property(
          "contact",
          bp::make_getter(&CostDataContactForce::contact,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataContactForce::contact),
