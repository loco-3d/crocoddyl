...
void exposeCostCentroidalMomentum() {
  ...
  bp::class_<CostModelCentroidalMomentum, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = h - href, with h "
      "and href as the current and reference "
      "centroidal momenta, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, Vector6d, int>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>,
                    boost::shared_ptr<ActivationModelAbstract>, Vector6d>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, Vector6d>(
          ...
          ":param state: state of the multibody system\n"
          ":param href: reference centroidal momentum"))
      .def<void (CostModelCentroidalMomentum::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelCentroidalMomentum::calc,
      ...
      .def<void (CostModelCentroidalMomentum::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelCentroidalMomentum::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelCentroidalMomentum::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelCentroidalMomentum::createData,
      ...
      .add_property("reference",
                    &CostModelCentroidalMomentum::get_reference<
                        MathBaseTpl<double>::Vector6s>,
                    &CostModelCentroidalMomentum::set_reference<
                        MathBaseTpl<double>::Vector6s>,
                    "reference centroidal momentum")
      .add_property(
          "href",
          bp::make_function(&CostModelCentroidalMomentum::get_reference<
                                MathBaseTpl<double>::Vector6s>,
                            deprecated<>("Deprecated. Use reference.")),
          bp::make_function(&CostModelCentroidalMomentum::set_reference<
                                MathBaseTpl<double>::Vector6s>,
                            deprecated<>("Deprecated. Use reference.")),
          "reference centroidal momentum");
  ...
  bp::class_<CostDataCentroidalMomentum, bp::bases<CostDataAbstract>>(
      ...
      .add_property("dhd_dq",
                    bp::make_getter(&CostDataCentroidalMomentum::dhd_dq,
                                    bp::return_internal_reference<>()),
                    "Jacobian of the centroidal momentum")
      .add_property("dhd_dv",
                    bp::make_getter(&CostDataCentroidalMomentum::dhd_dv,
                                    bp::return_internal_reference<>()),
                    "Jacobian of the centroidal momentum");
}
