...
void exposeCostImpulseWrenchCone() {
  bp::class_<CostModelImpulseWrenchCone, bp::bases<CostModelAbstract>>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameWrenchCone>(
          ...
          ":param state: state of the multibody system\n"
          ":param fref: frame Wrench cone"))
      .def<void (CostModelImpulseWrenchCone::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelImpulseWrenchCone::calc,
      ...
      .def<void (CostModelImpulseWrenchCone::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelImpulseWrenchCone::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelImpulseWrenchCone::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelImpulseWrenchCone::createData,
      ...
      .add_property("reference",
                    &CostModelImpulseWrenchCone::get_reference<FrameWrenchCone>,
                    &CostModelImpulseWrenchCone::set_reference<FrameWrenchCone>,
  ...
  bp::class_<CostDataImpulseWrenchCone, bp::bases<CostDataAbstract>>(
      ...
      .add_property(
          "impulse",
          bp::make_getter(&CostDataImpulseWrenchCone::impulse,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataImpulseWrenchCone::impulse),
          "impulse data associated with the current cost")
      .add_property("Arr_Rx",
                    bp::make_getter(&CostDataImpulseWrenchCone::Arr_Rx,
