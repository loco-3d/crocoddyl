...
void exposeCostFramePlacement() {
  bp::class_<CostModelFramePlacement, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = p - pref, with p "
      "and pref as the current and reference "
      "frame placements, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FramePlacement, int>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>,
                    boost::shared_ptr<ActivationModelAbstract>, FramePlacement>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FramePlacement>(
          ...
          ":param state: state of the multibody system\n"
          ":param Mref: reference frame placement"))
      .def<void (CostModelFramePlacement::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelFramePlacement::calc,
      ...
      .def<void (CostModelFramePlacement::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelFramePlacement::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelFramePlacement::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelFramePlacement::createData,
      ...
      .add_property("reference",
                    &CostModelFramePlacement::get_reference<FramePlacement>,
                    &CostModelFramePlacement::set_reference<FramePlacement>,
  ...
  bp::class_<CostDataFramePlacement, bp::bases<CostDataAbstract>>(
      ...
      .add_property("r",
                    bp::make_getter(&CostDataFramePlacement::r,
                                    bp::return_internal_reference<>()),
                    "cost residual")
      .add_property(
          "rMf",
          bp::make_getter(&CostDataFramePlacement::rMf,
                          bp::return_value_policy<bp::return_by_value>()),
          "error frame placement of the frame")
      .add_property("J",
                    bp::make_getter(&CostDataFramePlacement::J,
                                    bp::return_internal_reference<>()),
                    "Jacobian at the error point")
      .add_property("rJf",
                    bp::make_getter(&CostDataFramePlacement::rJf,
                                    bp::return_internal_reference<>()),
                    "error Jacobian of the frame")
      .add_property("fJf",
                    bp::make_getter(&CostDataFramePlacement::fJf,
                                    bp::return_internal_reference<>()),
