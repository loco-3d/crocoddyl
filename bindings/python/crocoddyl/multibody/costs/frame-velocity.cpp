...
void exposeCostFrameVelocity() {
  bp::class_<CostModelFrameVelocity, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = v - vref, with v "
      "and vref as the current and reference "
      "frame velocities, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameMotion, int>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>,
                    boost::shared_ptr<ActivationModelAbstract>, FrameMotion>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameMotion>(
          ...
          ":param state: state of the multibody system\n"
          ":param vref: reference frame velocity"))
      .def<void (CostModelFrameVelocity::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelFrameVelocity::calc,
      ...
      .def<void (CostModelFrameVelocity::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelFrameVelocity::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .add_property("reference",
                    &CostModelFrameVelocity::get_reference<FrameMotion>,
                    &CostModelFrameVelocity::set_reference<FrameMotion>,
