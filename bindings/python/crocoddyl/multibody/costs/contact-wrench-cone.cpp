...
void exposeCostContactWrenchCone() {
  bp::class_<CostModelContactWrenchCone, bp::bases<CostModelAbstract>>(
      ...
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameWrenchCone,
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameWrenchCone>(
          ...
          ":param state: state of the multibody system\n"
          ":param fref: frame wrench cone"))
      .def<void (CostModelContactWrenchCone::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelContactWrenchCone::calc,
      ...
      .def<void (CostModelContactWrenchCone::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelContactWrenchCone::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelContactWrenchCone::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelContactWrenchCone::createData,
      ...
      .add_property("reference",
                    &CostModelContactWrenchCone::get_reference<FrameWrenchCone>,
                    &CostModelContactWrenchCone::set_reference<FrameWrenchCone>,
                    "reference frame wrench cone");
  ...
  bp::class_<CostDataContactWrenchCone, bp::bases<CostDataAbstract>>(
      ...
      .add_property(
          "contact",
          bp::make_getter(&CostDataContactWrenchCone::contact,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataContactWrenchCone::contact),
          "contact data associated with the current cost")
      .add_property("Arr_Rx",
                    bp::make_getter(&CostDataContactWrenchCone::Arr_Rx,
      ...
      .add_property("Arr_Ru",
                    bp::make_getter(&CostDataContactWrenchCone::Arr_Ru,
                                    bp::return_internal_reference<>()),
