...
void exposeCostImpulseCoPPosition() {
  bp::class_<CostModelImpulseCoPPosition, bp::bases<CostModelAbstract>>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameCoPSupport>(
          ...
          ":param state: state of the multibody system\n"
          ":param cop_support: impulse frame Id and cop support region"))
      .def<void (CostModelImpulseCoPPosition::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelImpulseCoPPosition::calc,
      ...
      .def<void (CostModelImpulseCoPPosition::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelImpulseCoPPosition::calcDiff,
          bp::args("self", "data", "x", "u"),
          ...
          ":param x: state point\n"
          ":param u: control input\n")
      .def("createData", &CostModelImpulseCoPPosition::createData,
      ...
      .add_property(
          "reference",
          &CostModelImpulseCoPPosition::get_reference<FrameCoPSupport>,
          &CostModelImpulseCoPPosition::set_reference<FrameCoPSupport>,
  ...
  bp::class_<CostDataImpulseCoPPosition, bp::bases<CostDataAbstract>>(
      ...
      .add_property("Arr_Ru",
                    bp::make_getter(&CostDataImpulseCoPPosition::Arr_Ru,
                                    bp::return_internal_reference<>()),
                    "Intermediate product of Arr (2nd deriv of Activation) "
                    "with Ru (deriv of residue)")
      .add_property(
          "impulse",
          bp::make_getter(&CostDataImpulseCoPPosition::impulse,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataImpulseCoPPosition::impulse),
