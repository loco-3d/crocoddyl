...
void exposeCostContactImpulse() {
  bp::class_<CostModelContactImpulse, bp::bases<CostModelAbstract>>(
      ...
      "This cost function defines a residual vector as r = f-fref, where "
      "f,fref describe the current and reference "
      "the spatial impulses, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>,
               boost::shared_ptr<ActivationModelAbstract>, FrameForce>(
          ...
          ":param fref: reference spatial contact impulse in the contact "
          "coordinates"))
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameForce>(
          ...
          ":param fref: reference spatial contact impulse in the contact "
          "coordinates"))
      .def<void (CostModelContactImpulse::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelContactImpulse::calc,
      ...
      .def<void (CostModelContactImpulse::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelContactImpulse::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (CostModelContactImpulse::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData", &CostModelContactImpulse::createData,
           ...
           ":return cost data.")
      .add_property(
          "reference", &CostModelContactImpulse::get_reference<FrameForce>,
  ...
  bp::class_<CostDataContactImpulse, bp::bases<CostDataAbstract>>(
      ...
      .add_property(
          "impulse",
          bp::make_getter(&CostDataContactImpulse::impulse,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataContactImpulse::impulse),
