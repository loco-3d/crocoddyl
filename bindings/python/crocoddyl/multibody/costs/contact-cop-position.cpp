...
void exposeCostContactCoPPosition() {
  bp::class_<CostModelContactCoPPosition, bp::bases<CostModelAbstract>>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, FrameCoPSupport>(
          ...
          ":param state: state of the multibody system\n"
          ":param cop_support: contact frame ID and cop support region"))
      .def<void (CostModelContactCoPPosition::*)(
          const boost::shared_ptr<CostDataAbstract> &,
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calc", &CostModelContactCoPPosition::calc,
      ...
      .def<void (CostModelContactCoPPosition::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd> &,
          const Eigen::Ref<const Eigen::VectorXd> &)>(
          "calcDiff", &CostModelContactCoPPosition::calcDiff,
          bp::args("self", "data", "x", "u"),
          ...
          ":param x: state point\n"
          ":param u: control input\n")
      .def("createData", &CostModelContactCoPPosition::createData,
      ...
      .add_property(
          "reference",
          &CostModelContactCoPPosition::get_reference<FrameCoPSupport>,
          &CostModelContactCoPPosition::set_reference<FrameCoPSupport>,
  ...
  bp::class_<CostDataContactCoPPosition, bp::bases<CostDataAbstract>>(
      ...
      .add_property("Arr_Ru",
                    bp::make_getter(&CostDataContactCoPPosition::Arr_Ru,
                                    bp::return_internal_reference<>()),
                    "Intermediate product of Arr (2nd deriv of Activation) "
                    "with Ru (deriv of residue)")
      .add_property(
          "contact",
          bp::make_getter(&CostDataContactCoPPosition::contact,
                          bp::return_value_policy<bp::return_by_value>()),
          bp::make_setter(&CostDataContactCoPPosition::contact),
