...
void exposeResidualImpulseCoM() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_RESIDUAL_MODEL_IMPULSE_COM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_RESIDUAL_DATA_IMPULSE_COM_PYTHON_BINDINGS)
}
