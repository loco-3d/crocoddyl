...
void exposeSolverAbstract() {
  ...
  StdVectorPythonVisitor<CallbackAbstractPtr,
                         std::allocator<CallbackAbstractPtr>,
  ...
  bp::class_<SolverAbstract_wrap, boost::noncopyable>(
      ...
      bp::init<boost::shared_ptr<ShootingProblem>>(
          bp::args("self", "problem"), "Initialize the solver model.\n\n"
      ...
      .add_property("xs",
                    bp::make_function(
                        &SolverAbstract_wrap::get_xs,
                        bp::return_value_policy<bp::copy_const_reference>()),
                    bp::make_function(&SolverAbstract_wrap::set_xs),
                    "state trajectory")
      .add_property("us",
                    bp::make_function(
                        &SolverAbstract_wrap::get_us,
                        bp::return_value_policy<bp::copy_const_reference>()),
                    bp::make_function(&SolverAbstract_wrap::set_us),
                    "control sequence")
  ...
  bp::class_<CallbackAbstract_wrap, boost::noncopyable>(
      "CallbackAbstract", "Abstract class for solver callbacks.\n\n"
                          "A callback is used to diagnostic the behaviour of "
                          "our solver in each iteration of it.\n"
                          "For instance, it can be used to print values, "
                          "record data or display motions")
