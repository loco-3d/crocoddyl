  ...
  bp::class_<ControlParametrizationModelPolyZero, bp::bases<ControlParametrizationModelAbstract> >(
      ...
      .def<void (ControlParametrizationModelPolyZero::*)(const boost::shared_ptr<ControlParametrizationDataAbstract>&,
          ...
          "calcDiff", &ControlParametrizationModelPolyZero::calcDiff, bp::args("self", "data", "t", "p"),
           ...
           ":param t: normalized time in [0, 1].\n"
           ":param p: control parameters (dim control.np).")
      .def("multiplyByJacobian", &ControlParametrizationModelPolyZero::multiplyByJacobian_J, bp::args("self", "t", "p", "A"),
      ...
      .def("multiplyJacobianTransposeBy", &ControlParametrizationModelPolyZero::multiplyJacobianTransposeBy_J, bp::args("self", "t", "p", "A"),
      ...
      .add_property("nu", bp::make_function(&ControlParametrizationModelPolyZero::get_nu), "dimension of control tuple")
