...
void exposeControlPolyZero() {
  ...
  bp::class_<ControlPolyZero, bp::bases<ControlAbstract> >(
      ...
      .def("value", &ControlPolyZero::value, bp::args("self", "t", "p"),
      ...
      .def("dValue", &ControlPolyZero::dValue, bp::args("self", "t", "p"),
      ...
      .def("multiplyByDValue", &ControlPolyZero::multiplyByDValue, bp::args("self", "t", "p", "A"),
      ...
      .def("multiplyDValueTransposeBy", &ControlPolyZero::multiplyDValueTransposeBy, bp::args("self", "t", "p", "A"),
