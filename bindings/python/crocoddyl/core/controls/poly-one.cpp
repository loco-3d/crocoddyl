...
void exposeControlPolyOne() {
  ...
  bp::class_<ControlPolyOne, bp::bases<ControlAbstract> >(
      ...
      .def("value", &ControlPolyOne::value, bp::args("self", "t", "p"),
      ...
      .def("dValue", &ControlPolyOne::dValue, bp::args("self", "t", "p"),
      ...
      .def("multiplyByDValue", &ControlPolyOne::multiplyByDValue, bp::args("self", "t", "p", "A"),
      ...
      .def("multiplyDValueTransposeBy", &ControlPolyOne::multiplyDValueTransposeBy, bp::args("self", "t", "p", "A"),
