...
#define CROCODDYL_COST_ITEM_PYTHON_BINDINGS(Scalar)                       \
  typedef CostItemTpl<Scalar> Model;                                      \
  typedef Model::CostModelAbstract CostModel;                             \
  typedef std::shared_ptr<Model> CostItemPtr;                             \
  StdMapPythonVisitor<                                                    \
...
void exposeCostSum() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_COST_ITEM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_COST_MODEL_SUM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_COST_DATA_SUM_PYTHON_BINDINGS)
}
