...
void exposeActuationSquashing() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_ACTUATION_MODEL_SQUASHING_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_ACTUATION_DATA_SQUASHING_PYTHON_BINDINGS)
}
