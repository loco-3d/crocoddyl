...
void exposeActuationAbstract() {
  ...
  bp::class_<ActuationModelAbstract_wrap, boost::noncopyable>(
      ...
      "In crocoddyl, an actuation model is a block that takes u and outputs a "
      "(in continouos\n"
      "time), where a is the actuation signal of our system, and it also "
      "computes the derivatives\n"
      "of this model. These computations are mainly carry on inside calc() and "
      "calcDiff(),\n"
      "respectively.",
