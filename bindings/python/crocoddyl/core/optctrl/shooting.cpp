...
void exposeShootingProblem() {
  ...
  StdVectorPythonVisitor<ActionModelPtr, std::allocator<ActionModelPtr>,
                         true>::expose("StdVec_ActionModel");
  StdVectorPythonVisitor<ActionDataPtr, std::allocator<ActionDataPtr>,
                         true>::expose("StdVec_ActionData");
  ...
  bp::class_<ShootingProblem, boost::noncopyable>(
      ...
      .add_property(
          "T",
          bp::make_function(&ShootingProblem::get_T,
      ...
      .add_property(
          "nx",
          bp::make_function(&ShootingProblem::get_nx,
                            bp::return_value_policy<bp::return_by_value>()),
          "dimension of state tuple")
      .add_property(
          "ndx",
          bp::make_function(&ShootingProblem::get_ndx,
                            bp::return_value_policy<bp::return_by_value>()),
