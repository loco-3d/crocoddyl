...
#define CROCODDYL_CONSTRAINT_ITEM_PYTHON_BINDINGS(Scalar)                     \
  typedef ConstraintItemTpl<Scalar> Model;                                    \
  typedef Model::ConstraintModelAbstract ConstraintModel;                     \
  typedef std::shared_ptr<Model> ConstraintItemPtr;                           \
  StdMapPythonVisitor<                                                        \
  ...
  bp::class_<Model>("ConstraintItem", "Describe a constraint item.\n\n",      \
                    bp::init<std::string, std::shared_ptr<ConstraintModel>,   \
                        ...
                        "(default true)"))                                    \
      .def(ConstraintItemVisitor<Model>())                                    \
...
void exposeConstraintManager() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_ITEM_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_MODEL_MANAGER_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_DATA_MANAGER_PYTHON_BINDINGS)
}
