...
void exposeConstraintResidual() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_MODEL_RESIDUAL_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_DATA_RESIDUAL_PYTHON_BINDINGS)
}
