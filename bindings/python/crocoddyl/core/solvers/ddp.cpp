...
void exposeSolverDDP() {
  ...
  bp::class_<SolverDDP, bp::bases<SolverAbstract>>(
      ...
      .add_property(
          "fs",
          make_function(&SolverDDP::get_fs,
                        bp::return_value_policy<bp::copy_const_reference>()),
          "fs")
      .add_property(
          "regFactor",
          bp::make_function(
              &SolverDDP::get_regfactor,
              bp::return_value_policy<bp::copy_const_reference>()),
          bp::make_function(&SolverDDP::set_regfactor),
          "regularization factor used for increasing or decreasing the value.")
      .add_property("regMin",
                    bp::make_function(
                        &SolverDDP::get_regmin,
                        bp::return_value_policy<bp::copy_const_reference>()),
                    bp::make_function(&SolverDDP::set_regmin),
                    "minimum regularization value.")
      .add_property("regMax",
                    bp::make_function(
                        &SolverDDP::get_regmax,
                        bp::return_value_policy<bp::copy_const_reference>()),
                    bp::make_function(&SolverDDP::set_regmax),
