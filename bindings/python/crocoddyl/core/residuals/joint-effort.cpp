...
void exposeResidualJointEffort() {
  ...
  bp::class_<ResidualModelJointEffort, bp::bases<ResidualModelAbstract> >(
      ...
      .def(bp::init<boost::shared_ptr<StateAbstract>, boost::shared_ptr<ActuationModelAbstract>, std::size_t>(
          ...
          "Initialize the joint-effort residual model.\n\n"
          "The default reference joint-effort is obtained from np.zero(actuation.nu).\n"
          ":param state: state description\n"
          ":param actuation: actuation model\n"
          ":param nu: dimension of the control vector"))
      .def(bp::init<boost::shared_ptr<StateAbstract>, boost::shared_ptr<ActuationModelAbstract> >(
          ...
          ":param state: state description\n"
          ":param actuation: actuation model"))
      .def<void (ResidualModelJointEffort::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualModelJointEffort::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (ResidualModelJointEffort::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelJointEffort::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &ResidualModelJointEffort::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
