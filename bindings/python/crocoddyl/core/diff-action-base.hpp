...
class DifferentialActionModelAbstract_wrap : public DifferentialActionModelAbstract,
 ...
 public:
  ...
  void quasiStatic(const boost::shared_ptr<DifferentialActionDataAbstract>& data,
    ...
    return bp::call<void>(this->get_override("quasiStatic").ptr(), data, (Eigen::VectorXd)u, (Eigen::VectorXd)x,(std::size_t)maxiter,(double)tol);
  }
