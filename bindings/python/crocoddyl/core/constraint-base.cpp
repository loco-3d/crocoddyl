...
void exposeConstraintAbstract() {
  ...
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_MODEL_ABSTRACT_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_CONSTRAINT_DATA_ABSTRACT_PYTHON_BINDINGS)
}
