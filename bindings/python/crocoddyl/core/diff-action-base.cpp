...
void exposeDifferentialActionAbstract() {
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_DIFFACTION_MODEL_ABSTRACT_PYTHON_BINDINGS)
  CROCODDYL_PYTHON_SCALARS(CROCODDYL_DIFFACTION_DATA_ABSTRACT_PYTHON_BINDINGS)
}
