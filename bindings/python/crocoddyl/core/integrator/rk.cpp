...
void exposeIntegratedActionRK() {
  ...
  bp::enum_<RKType>("RKType").value("two", two).value("three", three).value("four", four).export_values();

  bp::class_<IntegratedActionModelRK, bp::bases<IntegratedActionModelAbstract, ActionModelAbstract> >(
      ...
      bp::init<boost::shared_ptr<DifferentialActionModelAbstract>, RKType, bp::optional<double, bool> >(
          bp::args("self", "diffModel", "rktype", "stepTime", "withCostResidual"),
          "Initialize the RK integrator.\n\n"
          ":param diffModel: differential action model\n"
          ":param rktype: type of RK integrator (options are two, three, and four)\n"
      ...
      .def(bp::init<boost::shared_ptr<DifferentialActionModelAbstract>,
                    boost::shared_ptr<ControlParametrizationModelAbstract>, RKType, bp::optional<double, bool> >(
          bp::args("self", "diffModel", "control", "rktype", "stepTime", "withCostResidual"),
          "Initialize the RK integrator.\n\n"
          ":param diffModel: differential action model\n"
          ...
          ":param stepTime: step time (default 1e-3)\n"
          ":param withCostResidual: includes the cost residuals and derivatives (default True)."))
      .def<void (IntegratedActionModelRK::*)(const boost::shared_ptr<ActionDataAbstract>&,
                                             const Eigen::Ref<const Eigen::VectorXd>&,
                                             const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &IntegratedActionModelRK::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (IntegratedActionModelRK::*)(const boost::shared_ptr<ActionDataAbstract>&,
                                             const Eigen::Ref<const Eigen::VectorXd>&,
                                             const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &IntegratedActionModelRK::calcDiff, bp::args("self", "data", "x", "u"),
  ...
  bp::class_<IntegratedActionDataRK, bp::bases<IntegratedActionDataAbstract> >(
      ...
      .add_property(
          "differential",
          bp::make_getter(&IntegratedActionDataRK::differential, bp::return_value_policy<bp::return_by_value>()),
          "list of differential action data")
      .add_property("control",
                    bp::make_getter(&IntegratedActionDataRK::control, bp::return_value_policy<bp::return_by_value>()),
                    "list of control parametrization data")
      .add_property("integral",
                    bp::make_getter(&IntegratedActionDataRK::integral, bp::return_value_policy<bp::return_by_value>()),
                    "list of RK terms related to the cost")
      .add_property("dx", bp::make_getter(&IntegratedActionDataRK::dx, bp::return_internal_reference<>()),
                    "state rate.")
      .add_property("ki", bp::make_getter(&IntegratedActionDataRK::ki, bp::return_internal_reference<>()),
                    "list of RK terms related to system dynamics")
      .add_property("y", bp::make_getter(&IntegratedActionDataRK::y, bp::return_internal_reference<>()),
                    "list of states where f is evaluated in the RK integration")
      .add_property("ws", bp::make_getter(&IntegratedActionDataRK::ws, bp::return_internal_reference<>()),
                    "control inputs evaluated in the RK integration")
      .add_property("dki_dx", bp::make_getter(&IntegratedActionDataRK::dki_dx, bp::return_internal_reference<>()),
                    "list of partial derivatives of RK nodes with respect to the state of the RK "
                    "integration. dki/dx")
      .add_property("dki_du", bp::make_getter(&IntegratedActionDataRK::dki_du, bp::return_internal_reference<>()),
                    "list of partial derivatives of RK nodes with respect to the control parameters of the RK "
                    "integration. dki/du")
      .add_property(
          "dyi_dx", bp::make_getter(&IntegratedActionDataRK::dyi_dx, bp::return_internal_reference<>()),
          "list of partial derivatives of RK dynamics with respect to the state of the RK integrator. dyi/dx")
      .add_property("dyi_du", bp::make_getter(&IntegratedActionDataRK::dyi_du, bp::return_internal_reference<>()),
                    "list of partial derivatives of RK dynamics with respect to the control parameters of the "
                    "RK integrator. dyi/du")
      .add_property("dli_dx", bp::make_getter(&IntegratedActionDataRK::dli_dx, bp::return_internal_reference<>()),
                    "list of partial derivatives of the cost with respect to the state of the RK "
                    "integration. dli_dx")
      .add_property("dli_du", bp::make_getter(&IntegratedActionDataRK::dli_du, bp::return_internal_reference<>()),
                    "list of partial derivatives of the cost with respect to the control input of the RK "
                    "integration. dli_du")
      .add_property("ddli_ddx", bp::make_getter(&IntegratedActionDataRK::ddli_ddx, bp::return_internal_reference<>()),
