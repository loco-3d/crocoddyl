...
void exposeIntegratedActionRK4() {
  bp::class_<IntegratedActionModelRK4, bp::bases<ActionModelAbstract>>(
      ...
      .add_property(
          ...
          &IntegratedActionModelRK4::set_differential,
          "differential action model")
      .add_property(
          "dt",
          bp::make_function(&IntegratedActionModelRK4::get_dt,
                            bp::return_value_policy<bp::return_by_value>()),
  ...
  bp::class_<IntegratedActionDataRK4, bp::bases<ActionDataAbstract>>(
      ...
      bp::init<IntegratedActionModelRK4 *>(
          bp::args("self", "model"), "Create RK4 integrator data.\n\n"
      ...
      .add_property("y",
                    bp::make_getter(&IntegratedActionDataRK4::y,
                                    bp::return_internal_reference<>()),
                    "List with the states where f is evaluated in the RK4 "
                    "integration scheme")
      .add_property("dx",
      ...
      .add_property("dki_dx",
                    bp::make_getter(&IntegratedActionDataRK4::dki_dx,
                                    bp::return_internal_reference<>()),
                    "List with the partial derivatives of dynamics with "
                    "respect to to the state of the RK4 "
                    "integration method. d(x+dx)/dx")
      .add_property("dki_du",
                    bp::make_getter(&IntegratedActionDataRK4::dki_du,
                                    bp::return_internal_reference<>()),
                    "List with the partial derivatives of dynamics with "
                    "respect to to the control of the RK4 "
                    "integration method. d(x+dx)/du")
      .add_property("dli_dx",
                    bp::make_getter(&IntegratedActionDataRK4::dli_dx,
                                    bp::return_internal_reference<>()),
                    "List with the partial derivatives of the cost with "
                    "respect to to the state of the RK4 "
                    "integration method.")
      .add_property("dli_du",
      ...
      .add_property("ddli_ddx",
                    bp::make_getter(&IntegratedActionDataRK4::ddli_ddx,
                                    bp::return_internal_reference<>()),
                    "List with the second partial derivatives of the cost with "
                    "respect to to the state of the RK4 "
                    "integration method.")
      ...
      .add_property("ddli_dxdu",
                    bp::make_getter(&IntegratedActionDataRK4::ddli_dxdu,
                                    bp::return_internal_reference<>()),
                    "List with the second partial derivatives of the cost with "
                    "respect to to the state and the "
                    "control of the RK4 "
                    "integration method.");
}
