...
void exposeDifferentialActionNumDiff() {
  ...
  StdVectorPythonVisitor<DifferentialActionModelPtr,
                         std::allocator<DifferentialActionModelPtr>,
                         true>::expose("StdVec_DiffActionModel");
  StdVectorPythonVisitor<DifferentialActionDataPtr,
                         std::allocator<DifferentialActionDataPtr>,
  ...
  bp::class_<DifferentialActionModelNumDiff,
      ...
      bp::init<boost::shared_ptr<DifferentialActionModelAbstract>,
               bp::optional<bool>>(bp::args("self", "model", "gaussApprox"),
                                   "Initialize the action model NumDiff.\n\n"
                                   ":param model: action model where we "
                                   "compute the derivatives through NumDiff,\n"
                                   ":param gaussApprox: compute the Hessian "
                                   "using Gauss approximation (default False)"))
