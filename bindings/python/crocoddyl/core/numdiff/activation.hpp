...
#ifndef BINDINGS_PYTHON_CROCODDYL_CORE_NUMDIFF_ACTIVATION_HPP_
#define BINDINGS_PYTHON_CROCODDYL_CORE_NUMDIFF_ACTIVATION_HPP_
...
void exposeActivationNumDiff() {
  ...
  bp::class_<ActivationDataNumDiff, bp::bases<ActionDataAbstract> >(
...
#endif  // BINDINGS_PYTHON_CROCODDYL_CORE_NUMDIFF_ACTIVATION_HPP_
