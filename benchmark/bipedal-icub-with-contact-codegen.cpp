...
#include "factory/biped-icub.hpp"
...
int main(int argc, char* argv[]) {
  ...
  crocoddyl::benchmark::build_biped_icub_action_models(runningModel, terminalModel);
  ...
  crocoddyl::benchmark::build_biped_icub_action_models(ad_runningModel, ad_terminalModel);
  boost::shared_ptr<crocoddyl::ActionModelAbstract> cg_runningModel =
      boost::make_shared<crocoddyl::ActionModelCodeGen>(ad_runningModel, runningModel,
                                                        "biped_icub_with_contact_running_cg");
  boost::shared_ptr<crocoddyl::ActionModelAbstract> cg_terminalModel =
      boost::make_shared<crocoddyl::ActionModelCodeGen>(ad_terminalModel, terminalModel,
                                                        "biped_icub_with_contact_terminal_cg");
  ...
  default_state << dm->get_pinocchio().referenceConfigurations["half_sitting"],
