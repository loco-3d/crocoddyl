...
#ifndef CROCODDYL_QUADRUPED_HYQ_FACTORY_HPP_
#define CROCODDYL_QUADRUPED_HYQ_FACTORY_HPP_
...
void build_quadruped_hyq_action_models(boost::shared_ptr<crocoddyl::ActionModelAbstractTpl<Scalar> >& runningModel,
  ...
  const std::string RF = "rf_kfe_joint";
  const std::string LF = "lf_kfe_joint";
  const std::string LH = "lh_kfe_joint";
  ...
  pinocchio::srdf::loadReferenceConfigurations(modeld, EXAMPLE_ROBOT_DATA_MODEL_DIR "/hyq_description/srdf/hyq.srdf",
                                               false);
  ...
  FramePlacement Mref(model.getFrameId("rh_kfe_joint"),
