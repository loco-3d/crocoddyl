...
int main(int argc, char* argv[]) {
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded calcDiff [mean +- stddev in us]: "
              << avg_cd[ithread] << " +- "<< stddev_cd[ithread] << " (per nodes/thread: "
              << avg_cd[ithread]*(ithread+1)/N << " +- "<< stddev_cd[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded calc [mean +- stddev in us]: "
              << avg_calc[ithread] << " +- "<< stddev_calc[ithread] << " (per nodes/thread: "
              << avg_calc[ithread]*(ithread+1)/N << " +- "<< stddev_calc[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded differential calc [mean +- stddev in us]: "
              << avg_dcalc[ithread] << " +- "<< stddev_dcalc[ithread] << " (per nodes/thread: "
              << avg_dcalc[ithread]*(ithread+1)/N << " +- "<< stddev_dcalc[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded aba [mean +- stddev in us]: "
              << avg_dcalcpin[ithread] << " +- "<< stddev_dcalcpin[ithread] << " (per nodes/thread: "
              << avg_dcalcpin[ithread]*(ithread+1)/N << " +- "<< stddev_dcalcpin[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded aba-derivs [mean +- stddev in us]: "
              << avg_diffcalcpin[ithread] << " +- "<< stddev_diffcalcpin[ithread] << " (per nodes/thread: "
              << avg_diffcalcpin[ithread]*(ithread+1)/N << " +- "<< stddev_diffcalcpin[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  std::cout << "backwardPass [mean +- stddev in us]: "
            << avg_bp << " +- "<< stddev_bp << " (per nodes: "
            << avg_bp/N << " +- "<< stddev_bp/N << ")" << std::endl;
  ...
  std::cout << "forwardPass [mean +- stddev in us]: "
            << avg_fp << " +- "<< stddev_fp << " (per nodes: "
            << avg_fp/N << " +- "<< stddev_fp/N << ")" << std::endl;  
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded calcDiff [mean +- stddev in us]: "
              << cg_avg_cd[ithread] << " +- "<< cg_stddev_cd[ithread] << " (per nodes/thread: "
              << cg_avg_cd[ithread]*(ithread+1)/N << " +- "<< cg_stddev_cd[ithread]*(ithread+1)/N << ")" << std::endl;
  }
  ...
  for (int ithread=0; ithread<NTHREAD; ++ithread) {
    ...
    std::cout << ithread+1 << " threaded calc [mean +- stddev in us]: "
              << cg_avg_calc[ithread] << " +- "<< cg_stddev_calc[ithread] << " (per nodes/thread: "
              << cg_avg_calc[ithread]*(ithread+1)/N << " +- "<< cg_stddev_calc[ithread]*(ithread+1)/N << ")" << std::endl;
  }
}
