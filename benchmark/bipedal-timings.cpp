...
int main(int argc, char *argv[]) {
  ...
  boost::shared_ptr<crocoddyl::CostModelAbstract> goalTrackingCost =
      boost::make_shared<crocoddyl::CostModelFramePlacement>(
          state, Mref, actuation->get_nu());
  ...
  boost::shared_ptr<crocoddyl::CostModelAbstract> uRegCost =
      boost::make_shared<crocoddyl::CostModelControl>(state,
                                                      actuation->get_nu());
  ...
  crocoddyl::FramePlacement xref(model.getFrameId(RF),
                                 pinocchio::SE3::Identity());
  boost::shared_ptr<crocoddyl::ContactModelAbstract> support_contact_model6D =
      boost::make_shared<crocoddyl::ContactModel6D>(
          state, xref, actuation->get_nu(), Eigen::Vector2d(0., 50.));
  contact_models->addContact(model.frames[model.getFrameId(RF)].name +
                                 "_contact",
                             support_contact_model6D);

  crocoddyl::FrameTranslation x2ref(model.getFrameId(LF),
                                    Eigen::Vector3d::Zero());
  boost::shared_ptr<crocoddyl::ContactModelAbstract> support_contact_model3D =
      boost::make_shared<crocoddyl::ContactModel3D>(
          state, x2ref, actuation->get_nu(), Eigen::Vector2d(0., 50.));
  contact_models->addContact(model.frames[model.getFrameId(LF)].name +
                                 "_contact",
  ...
  boost::shared_ptr<crocoddyl::ActionDataAbstract> runningModel_data =
  ...
  std::cout << "pinocchio::difference :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "pinocchio::integrate :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.diff :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.integrate :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "pinocchio::dIntegrate ARG1 :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "pinocchio::dIntegrate ARG0 :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "pin::dIntegrateTransport with aliasing:\t" << AVG(duration)
            << " us\t" << STDDEV(duration) << " us\t" << duration.maxCoeff()
  ...
  std::cout << "pin::dIntegrateTransport w/o aliasing:\t" << AVG(duration)
            << " us\t" << STDDEV(duration) << " us\t" << duration.maxCoeff()
            << " us\t" << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jdiff both :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jdiff first :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jdiff second :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jintegrate both :\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jintegrate first :\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "StateMultibody.Jintegrate second :\t" << AVG(duration)
            << " us\t" << STDDEV(duration) << " us\t" << duration.maxCoeff()
            << " us\t" << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ActivationModelQuad.calc :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ActivationModelQuad.calcdiff :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ActuationModelFloatingBase.calc :\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ActuationModelFloatingBase.calcdiff :\t" << AVG(duration)
            << " us\t" << STDDEV(duration) << " us\t" << duration.maxCoeff()
            << " us\t" << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelFramePlacement.calc :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelFramePlacement.calcdiff :\t" << AVG(duration)
            << " us\t" << STDDEV(duration) << " us\t" << duration.maxCoeff()
            << " us\t" << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelState.calc :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelState.calcdiff :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelControl.calc :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelControl.calcdiff :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelSum calc :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "CostModelSum calcdiff :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ContactDAM.calc :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "Contact DAM calcDiff :\t\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ContactDAM+EulerIAM calc :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
  ...
  std::cout << "ContactDAM+EulerIAM calcDiff :\t\t" << AVG(duration) << " us\t"
            << STDDEV(duration) << " us\t" << duration.maxCoeff() << " us\t"
            << duration.minCoeff() << " us" << std::endl;
}
