...
int main(int argc, char* argv[]) {
  ...
  RigidContactModel ci_LF(pinocchio::CONTACT_6D,model.getFrameId(LF),pinocchio::LOCAL);
  RigidContactModel ci_RF(pinocchio::CONTACT_3D,model.getFrameId(RF),pinocchio::LOCAL);
  ...
  duration = 0;    timer.reset();
  SMOOTH(T) {
    pinocchio::difference(model, x1s[_smooth].head(model.nq),
                          x2s[_smooth].head(model.nq), dxs[_smooth].head(model.nv));
  }
  duration = timer.get_us_duration();
  std::cout <<"pinocchio::difference (in us):\t\t\t"
            << duration/T << " us" << std::endl;

  duration = 0;    timer.reset();
  SMOOTH(T) {
    pinocchio::integrate(model, x1s[_smooth].head(model.nq),
                         dxs[_smooth].head(model.nv), x2s[_smooth].head(model.nq));
  }
  duration = timer.get_us_duration();
  std::cout <<"pinocchio::integrate (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.diff (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.integrate (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = 0;    timer.reset();
  SMOOTH(T) {
    pinocchio::dIntegrate(model, x1s[_smooth].head(model.nq),
                          dxs[_smooth].head(model.nv),
                          Jsecond.bottomLeftCorner(model.nv, model.nv), pinocchio::ARG1);
  }
  duration = timer.get_us_duration();
  std::cout <<"pinocchio::dIntegrate ARG1 (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"pinocchio::dIntegrate ARG0 (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jdiff both (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jdiff first (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jdiff second (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jintegrate both (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jintegrate first (in us):\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"StateMultibody.Jintegrate second (in us):\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ActivationModelQuad.calc (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ActivationModelQuad.calcdiff (in us):\t\t"
            << duration/T << " us" << std::endl;
...
/*************************************Actuation*******************/
  ...
  duration = timer.get_us_duration();
  std::cout <<"ActuationModelFloatingBase.calc (in us):\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ActuationModelFloatingBase.calcdiff (in us):\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelFramePlacement.calc (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelFramePlacement.calcdiff (in us):\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelState.calc (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelState.calcdiff (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelControl.calc (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelControl.calcdiff (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelSum calc (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"CostModelSum calcdiff (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ContactDAM.calc (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"Contact DAM calcDiff (in us):\t\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ContactDAM+EulerIAM calc (in us):\t\t"
            << duration/T << " us" << std::endl;
  ...
  duration = timer.get_us_duration();
  std::cout <<"ContactDAM+EulerIAM calcDiff (in us):\t\t"
            << duration/T << " us" << std::endl;
