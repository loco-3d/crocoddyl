...
#include "factory/quadruped-anymal.hpp"
...
int main(int argc, char* argv[]) {
  ...
  crocoddyl::benchmark::build_quadruped_anymal_action_models(runningModel, terminalModel);
  ...
  crocoddyl::benchmark::build_quadruped_anymal_action_models(ad_runningModel, ad_terminalModel);
  boost::shared_ptr<crocoddyl::ActionModelAbstract> cg_runningModel =
      boost::make_shared<crocoddyl::ActionModelCodeGen>(ad_runningModel, runningModel,
                                                        "quadruped_anymal_with_contact_running_cg");
  boost::shared_ptr<crocoddyl::ActionModelAbstract> cg_terminalModel =
      boost::make_shared<crocoddyl::ActionModelCodeGen>(ad_terminalModel, terminalModel,
                                                        "quadruped_anymal_with_contact_terminal_cg");
