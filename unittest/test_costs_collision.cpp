...
void test_calc_returns_a_cost(CostModelCollisionTypes::Type cost_type, StateModelTypes::Type state_type) {
  // create the model
...
void register_cost_model_unit_tests(CostModelCollisionTypes::Type cost_type, StateModelTypes::Type state_type) {
