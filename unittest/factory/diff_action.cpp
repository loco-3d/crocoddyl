...
DifferentialActionModelFactory::create(
  ...
  case DifferentialActionModelTypes::DifferentialActionModelLQRDriftFree:
    action =
        boost::make_shared<crocoddyl::DifferentialActionModelLQR>(40, 40, true);
    break;
  case DifferentialActionModelTypes::
      DifferentialActionModelFreeFwdDynamics_TalosArm:
...
DifferentialActionModelFactory::create_freeFwdDynamics(
  ...
  cost->addCost("frame",
                CostModelFactory().create(
                    CostModelTypes::CostModelFramePlacement, state_type,
                    ActivationModelTypes::ActivationModelQuad),
                1.);
  action =
...
DifferentialActionModelFactory::create_contactFwdDynamics(
    ...
    if (with_friction) {
      cost->addCost(
          ...
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(state->get_pinocchio()->getFrameId(
                                               "gripper_left_fingertip_1_link"),
                                           cone),
              actuation->get_nu()),
          0.1);
  ...
  case StateModelTypes::StateMultibody_HyQ:
    contact->addContact(
        "lf", ContactModelFactory().create(ContactModelTypes::ContactModel3D,
                                           PinocchioModelTypes::HyQ, "lf_foot",
                                           actuation->get_nu()));
    contact->addContact(
        "rf", ContactModelFactory().create(ContactModelTypes::ContactModel3D,
                                           PinocchioModelTypes::HyQ, "rf_foot",
                                           actuation->get_nu()));
    contact->addContact(
        "lh", ContactModelFactory().create(ContactModelTypes::ContactModel3D,
                                           PinocchioModelTypes::HyQ, "lh_foot",
                                           actuation->get_nu()));
    contact->addContact(
        "rh", ContactModelFactory().create(ContactModelTypes::ContactModel3D,
      ...
      cost->addCost(
          ...
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              ...
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("lf_foot"), cone),
              actuation->get_nu()),
          0.1);
      cost->addCost(
          "rf_cone",
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("rf_foot"), cone),
              actuation->get_nu()),
          0.1);
      cost->addCost(
          "lh_cone",
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("lh_foot"), cone),
              actuation->get_nu()),
          0.1);
      cost->addCost(
          "rh_cone",
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("rh_foot"), cone),
              actuation->get_nu()),
          0.1);
    }
    break;
  case StateModelTypes::StateMultibody_Talos:
    contact->addContact("lf", ContactModelFactory().create(
                                  ContactModelTypes::ContactModel6D,
    ...
    if (with_friction) {
      cost->addCost(
          ...
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("left_sole_link"), cone),
              actuation->get_nu()),
          0.1);
      cost->addCost(
          "rf_cone",
          boost::make_shared<crocoddyl::CostModelContactFrictionCone>(
              state, activation,
              crocoddyl::FrameFrictionCone(
                  state->get_pinocchio()->getFrameId("right_sole_link"), cone),
              actuation->get_nu()),
          0.1);
    }
    break;
