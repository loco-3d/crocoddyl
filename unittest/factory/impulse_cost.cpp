...
const std::vector<ImpulseCostModelTypes::Type>
    ImpulseCostModelTypes::all(ImpulseCostModelTypes::init_all());
...
ImpulseCostModelFactory::create(
  ...
  switch (cost_type) {
  case ImpulseCostModelTypes::CostModelImpulseCoM:
    cost = boost::make_shared<crocoddyl::CostModelImpulseCoM>(
