...
ActionModelFactory::create_impulseFwdDynamics(
  ...
  case StateModelTypes::StateMultibody_HyQ:
    impulse->addImpulse("lf", ImpulseModelFactory().create(
                                  ImpulseModelTypes::ImpulseModel3D,
  ...
  case StateModelTypes::StateMultibody_Talos:
    impulse->addImpulse(
        "lf", ImpulseModelFactory().create(ImpulseModelTypes::ImpulseModel6D,
                                           PinocchioModelTypes::Talos,
                                           "left_sole_link"));
    impulse->addImpulse(
        "rf", ImpulseModelFactory().create(ImpulseModelTypes::ImpulseModel6D,
                                           PinocchioModelTypes::Talos,
                                           "right_sole_link"));
    break;
  default:
