...
void test_constructor() {
  ...
  BOOST_CHECK(static_cast<std::size_t>(cone.get_A().rows()) ==
              cone.get_nf() + 1);
  BOOST_CHECK(static_cast<std::size_t>(cone.get_lb().size()) ==
              cone.get_nf() + 1);
  BOOST_CHECK(static_cast<std::size_t>(cone.get_ub().size()) ==
              cone.get_nf() + 1);
}
