...
class ActionsTest(CopyModelTestCase):
    ...
    MODEL.append(crocoddyl.DifferentialActionModelContactFwdDynamics(state, actuation, contact, cost))
    MODEL.append(crocoddyl.DifferentialActionModelFreeFwdDynamics(state, actuation, cost))
    cost = crocoddyl.CostModelSum(state, state.nv)
    contact = crocoddyl.ContactModelMultiple(state, state.nv)
    MODEL.append(crocoddyl.DifferentialActionModelContactInvDynamics(state, actuation, contact, cost))
    MODEL.append(crocoddyl.DifferentialActionModelFreeInvDynamics(state, actuation, cost))
    # integrated actions
    MODEL.append(crocoddyl.IntegratedActionModelAbstract(crocoddyl.DifferentialActionModelLQR(2, 2), 0.1))
    MODEL.append(crocoddyl.IntegratedActionModelEuler(crocoddyl.DifferentialActionModelLQR(2, 2), 0.1))
    MODEL.append(
        crocoddyl.IntegratedActionModelRK(crocoddyl.DifferentialActionModelLQR(2, 2), crocoddyl.RKType.two, 0.1))
    # numdiff actions
    MODEL.append(crocoddyl.ActionModelNumDiff(crocoddyl.ActionModelLQR(2, 2)))
    MODEL.append(crocoddyl.DifferentialActionModelNumDiff(crocoddyl.DifferentialActionModelLQR(2, 2)))
...
class ResidualsTest(CopyModelTestCase):
    ...
    MODEL.append(crocoddyl.ResidualModelFramePlacement(state, frame_id, pinocchio.SE3.Random()))
    COLLECTOR.append(crocoddyl.DataCollectorMultibody(pdata))
    MODEL.append(crocoddyl.ResidualModelFrameRotation(state, frame_id, pinocchio.SE3.Random().rotation))
    COLLECTOR.append(crocoddyl.DataCollectorMultibody(pdata))
    MODEL.append(crocoddyl.ResidualModelFrameTranslation(state, frame_id, pinocchio.SE3.Random().translation))
    COLLECTOR.append(crocoddyl.DataCollectorMultibody(pdata))
    MODEL.append(
        crocoddyl.ResidualModelFrameVelocity(state, frame_id, pinocchio.Motion.Random(),
    ...
    MODEL.append(crocoddyl.ResidualModelContactCoPPosition(state, frame_id, crocoddyl.CoPSupport()))
    COLLECTOR.append(crocoddyl.DataCollectorActMultibodyInContact(pdata, adata, cdata))
    MODEL.append(crocoddyl.ResidualModelContactForce(state, frame_id, pinocchio.Force.Random(), 6))
    COLLECTOR.append(crocoddyl.DataCollectorActMultibodyInContact(pdata, adata, cdata))
    MODEL.append(crocoddyl.ResidualModelContactFrictionCone(state, frame_id, crocoddyl.FrictionCone()))
    COLLECTOR.append(crocoddyl.DataCollectorActMultibodyInContact(pdata, adata, cdata))
    MODEL.append(crocoddyl.ResidualModelContactWrenchCone(state, frame_id, crocoddyl.WrenchCone()))
    COLLECTOR.append(crocoddyl.DataCollectorActMultibodyInContact(pdata, adata, cdata))
...
class ActivationsTest(CopyModelTestCase):
    ...
    MODEL.append(crocoddyl.ActivationModelNumDiff(crocoddyl.ActivationModel2NormBarrier(2)))
...
class ControlsTest(CopyModelTestCase):
    ...
    MODEL.append(crocoddyl.ControlParametrizationModelPolyTwoRK(2, crocoddyl.RKType.two))
...
class ActuationsTest(CopyModelTestCase):
    ...
    MODEL.append(
        crocoddyl.ActuationSquashingModel(actuation, crocoddyl.SquashingModelSmoothSat(np.zeros(2), np.ones(2), 2),
                                          actuation.nu))
