...
struct CGActionAbstract {
 public:
  ...
  CGActionModelAbstract(boost::shared_ptr<BaseModel> base_model, boost::shared_ptr<BaseData> base_data)
  ...
  CppAD::cg::ModelCSourceGen<Scalar>& codeGenerator() { return *cgen_ptr; }
