...
template<typename Scalar>
const boost::shared_ptr<ActivationModelAbstractTpl<Scalar> >& ActivationModelNumDiffTpl<Scalar>::get_model() const { return model_; }
  
template<typename Scalar>
const Scalar& ActivationModelNumDiffTpl<Scalar>::get_disturbance() const { return disturbance_; }
