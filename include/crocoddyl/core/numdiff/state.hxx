...
//
// Copyright (C) 2019-2020, LAAS-CNRS, University of Edinburgh, New York
// University, Max Planck Gesellschaft Copyright note valid unless otherwise
// stated in individual files. All rights reserved.
///////////////////////////////////////////////////////////////////////////////
...
StateNumDiffTpl<Scalar>::StateNumDiffTpl(boost::shared_ptr<Base> state)
    : Base(state->get_nx(), state->get_ndx()), state_(state),
      disturbance_(1e-6) {}

template <typename Scalar> StateNumDiffTpl<Scalar>::~StateNumDiffTpl() {}
