...
namespace crocoddyl {
  ...
  template<typename Scalar> class DifferentialActionDataAbstractTpl;
  template<typename Scalar> class DifferentialActionModelLQRTpl;
  template<typename Scalar> class DifferentialActionDataLQRTpl;
  //Actions
  ...
  //Activations
  template<typename Scalar> class ActivationDataQuadraticBarrierTpl;
  template<typename Scalar> class ActivationModelQuadraticBarrierTpl;
  template<typename Scalar> class ActivationBoundsTpl;
  ...
  template<typename Scalar> class ActivationDataWeightedQuadTpl;
  template<typename Scalar> class ActivationModelSmoothAbsTpl;
  template<typename Scalar> class ActivationDataSmoothAbsTpl;
  template<typename Scalar> class ActivationModelAbstractTpl;
  template<typename Scalar> class ActivationDataAbstractTpl; 
  //State
  template<typename Scalar> class StateAbstractTpl; 
  //Actuations
  template<typename Scalar> class ActuationDataAbstractTpl;
  ...
  template<typename Scalar> class IntegratedActionDataEulerTpl;
  //State
  template<typename Scalar> class StateVectorTpl;
  //Datacollect
  template<typename Scalar> class DataCollectorActuationTpl;
  //ActionData
