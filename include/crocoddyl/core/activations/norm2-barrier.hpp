...
//
// Copyright (C) 2021s, LAAS-CNRS, Airbus
// Copyright note valid unless otherwise stated in individual files.
// All rights reserved.
///////////////////////////////////////////////////////////////////////////////

#ifndef CROCODDYL_CORE_ACTIVATIONS_NORM2_BARRIER_HPP_
#define CROCODDYL_CORE_ACTIVATIONS_NORM2_BARRIER_HPP_
...
class ActivationModelNorm2BarrierTpl : public ActivationModelAbstractTpl<_Scalar> {
 public:
  ...
  typedef ActivationDataNorm2BarrierTpl<Scalar> Data;
  ...
  virtual void calcDiff(const boost::shared_ptr<ActivationDataAbstract>& data, const Eigen::Ref<const VectorXs>& r) {
    ...
    if(d->distance_ < threshold_) {
      ...
      //data->Arr.diagonal() = threshold_ * r.array().square() / std::pow(d->distance_, 3); // True Hessian
...
template <typename _Scalar>
struct ActivationDataNorm2BarrierTpl : public ActivationDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  explicit ActivationDataNorm2BarrierTpl(Activation* const activation)
    : Base(activation),
      distance_(Scalar(0))
  {}
...
#endif  // CROCODDYL_CORE_ACTIVATIONS_NORM2_BARRIER_HPP_
