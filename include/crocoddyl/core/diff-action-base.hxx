...
template <typename Scalar>
void DifferentialActionModelAbstractTpl<Scalar>::multiplyFxTransposeBy(const Eigen::Ref<const MatrixXs>& Fx,
                                                                       const Eigen::Ref<const MatrixXs>& A,
...
template <typename Scalar>
void DifferentialActionModelAbstractTpl<Scalar>::multiplyFuTransposeBy(const Eigen::Ref<const MatrixXs>& Fu,
                                                                       const Eigen::Ref<const MatrixXs>& A,
                                                                       Eigen::Ref<MatrixXsRowMajor> out,
                                                                       const AssignmentOp op) const {
  assert_pretty(is_a_AssignmentOp(op), ("op must be one of the AssignmentOp {settop, addto, rmfrom}"));
...
template <typename Scalar>
std::size_t DifferentialActionModelAbstractTpl<Scalar>::get_ngx() const {
  return *ngx_;
}

template <typename Scalar>
std::size_t DifferentialActionModelAbstractTpl<Scalar>::get_nhx() const {
  return *nhx_;
}
