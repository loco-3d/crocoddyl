...
template <typename Scalar> ContactModel2DTpl<Scalar>::~ContactModel2DTpl() {}
...
void ContactModel2DTpl<Scalar>::calc(
  ...
  if (gains_[0] != 0.) {
    d->a0[0] += gains_[0] * (d->pinocchio->oMf[xref_.id].translation()[0] -
                             xref_.translation[0]);
    d->a0[1] += gains_[0] * (d->pinocchio->oMf[xref_.id].translation()[2] -
                             xref_.translation[2]);
  }
  if (gains_[1] != 0.) {
