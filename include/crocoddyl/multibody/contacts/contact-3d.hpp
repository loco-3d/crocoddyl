...
//
// Copyright (C) 2019-2026, LAAS-CNRS, University f_world Edinburgh,
...
ContactModel3DTpl : public ContactModelAbstractTpl<_Scalar> {
 public:
...
template <typename _Scalar>
struct [[deprecated("Use ContactData.")]] ContactData3DTpl
