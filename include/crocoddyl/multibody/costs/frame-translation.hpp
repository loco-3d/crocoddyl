...
public:
  ...
  DEPRECATED("Use set_reference<FrameTranslation<Scalar> >()",
             void set_xref(const FrameTranslation &xref_in));
  DEPRECATED("Use get_reference<FrameTranslation<Scalar> >()",
...
struct CostDataFrameTranslationTpl : public CostDataAbstractTpl<_Scalar> {
  ...
  CostDataFrameTranslationTpl(Model<Scalar> *const model,
                              DataCollectorAbstract *const data)
      : Base(model, data), J(3, model->get_state()->get_nv()),
