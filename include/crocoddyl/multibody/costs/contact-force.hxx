...
template <typename Scalar>
void CostModelContactForceTpl<Scalar>::calc(
...
template <typename Scalar>
void CostModelContactForceTpl<Scalar>::calcDiff(
    const boost::shared_ptr<CostDataAbstract> &data,
...
CostModelContactForceTpl<Scalar>::createData(
...
template <typename Scalar>
void CostModelContactForceTpl<Scalar>::set_referenceImpl(
...
template <typename Scalar>
void CostModelContactForceTpl<Scalar>::get_referenceImpl(
...
CostModelContactForceTpl<Scalar>::get_fref() const {
  return fref_;
}
