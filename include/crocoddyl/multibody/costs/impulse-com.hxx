...
template <typename Scalar>
void CostModelImpulseCoMTpl<Scalar>::calc(
...
template <typename Scalar>
void CostModelImpulseCoMTpl<Scalar>::calcDiff(
    const boost::shared_ptr<CostDataAbstract> &data,
...
CostModelImpulseCoMTpl<Scalar>::createData(DataCollectorAbstract *const data) {
