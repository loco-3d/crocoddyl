...
template <typename Scalar>
CostModelFrameTranslationTpl<Scalar>::CostModelFrameTranslationTpl(
    boost::shared_ptr<StateMultibody> state, const FrameTranslation &xref,
    const std::size_t &nu)
...
template <typename Scalar>
void CostModelFrameTranslationTpl<Scalar>::calc(
...
template <typename Scalar>
void CostModelFrameTranslationTpl<Scalar>::calcDiff(
    const boost::shared_ptr<CostDataAbstract> &data,
    const Eigen::Ref<const VectorXs> &, const Eigen::Ref<const VectorXs> &) {
  ...
  pinocchio::getFrameJacobian(*pin_model_.get(), *d->pinocchio, xref_.id,
...
CostModelFrameTranslationTpl<Scalar>::createData(
...
template <typename Scalar>
void CostModelFrameTranslationTpl<Scalar>::set_referenceImpl(
...
template <typename Scalar>
void CostModelFrameTranslationTpl<Scalar>::get_referenceImpl(
...
template <typename Scalar>
const FrameTranslationTpl<Scalar> &
CostModelFrameTranslationTpl<Scalar>::get_xref() const {
  return xref_;
}

template <typename Scalar>
void CostModelFrameTranslationTpl<Scalar>::set_xref(
