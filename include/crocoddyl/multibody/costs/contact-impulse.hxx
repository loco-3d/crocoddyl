...
template <typename Scalar>
CostModelContactImpulseTpl<Scalar>::CostModelContactImpulseTpl(
    boost::shared_ptr<StateMultibody> state, const FrameForce &fref,
    const std::size_t &nr)
...
template <typename Scalar>
void CostModelContactImpulseTpl<Scalar>::calc(
...
template <typename Scalar>
void CostModelContactImpulseTpl<Scalar>::calcDiff(
    const boost::shared_ptr<CostDataAbstract> &data,
...
CostModelContactImpulseTpl<Scalar>::createData(
...
template <typename Scalar>
void CostModelContactImpulseTpl<Scalar>::set_referenceImpl(
...
template <typename Scalar>
void CostModelContactImpulseTpl<Scalar>::get_referenceImpl(
...
template <typename Scalar>
const FrameForceTpl<Scalar> &
CostModelContactImpulseTpl<Scalar>::get_fref() const {
  return fref_;
}
