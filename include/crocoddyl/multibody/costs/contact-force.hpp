 ...
 *
 * It builds a cost function that tracks a desired spatial force in the contact coordinates
...
class CostModelContactForceTpl : public CostModelAbstractTpl<_Scalar> {
 ...
 protected:
  FrameForce fref_;  //!< Reference spatial contact force in the contact coordinates
                     //!< \f${}^o\underline{\boldsymbol{\lambda}}_c^{reference}\f$
};
