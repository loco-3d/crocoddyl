 ...
 * dimension of the residual vector is 6.
 *
...
public:
  ...
  CostModelFrameVelocityTpl(
      ...
      const FrameMotion &Fref, const std::size_t &nu);
  ...
  DEPRECATED("Use set_reference<FrameMotionTpl<Scalar> >()",
             void set_vref(const FrameMotion &vref_in));
  DEPRECATED("Use get_reference<FrameMotionTpl<Scalar> >()",
...
struct CostDataFrameVelocityTpl : public CostDataAbstractTpl<_Scalar> {
  ...
  CostDataFrameVelocityTpl(Model<Scalar> *const model,
