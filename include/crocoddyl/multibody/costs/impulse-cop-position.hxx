...
template <typename Scalar>
void CostModelImpulseCoPPositionTpl<Scalar>::calc(
  ...
  data->r.noalias() =
      cop_support_.get_A() * d->impulse->jMf.actInv(d->impulse->f).toVector();
...
template <typename Scalar>
void CostModelImpulseCoPPositionTpl<Scalar>::set_referenceImpl(
...
template <typename Scalar>
void CostModelImpulseCoPPositionTpl<Scalar>::get_referenceImpl(
