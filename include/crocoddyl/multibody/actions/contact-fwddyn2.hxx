...
DifferentialActionModelContactFwdDynamics2Tpl<Scalar>::createData() {
  ...
  DifferentialActionDataContactFwdDynamics2* d = 
    static_cast<DifferentialActionDataContactFwdDynamics2*>(data.get());
  ...
  /*
 template <typename Scalar>
void DifferentialActionModelContactFwdDynamics2Tpl<Scalar>::quasiStatic(const boost::shared_ptr<DifferentialActionDataAbstract>& data,
