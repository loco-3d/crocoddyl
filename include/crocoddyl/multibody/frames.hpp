...
template <typename _Scalar> struct FrameTranslationTpl {
...
template <typename _Scalar> struct FrameRotationTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  FrameRotationTpl(const FrameRotationTpl<Scalar> &value)
      : id(value.id), rotation(value.rotation) {}
...
template <typename _Scalar> struct FramePlacementTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  FramePlacementTpl(const FramePlacementTpl<Scalar> &value)
      : id(value.id), placement(value.placement) {}
...
template <typename _Scalar> struct FrameMotionTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  typedef _Scalar Scalar;
  typedef pinocchio::MotionTpl<Scalar> Motion;

  explicit FrameMotionTpl()
...
template <typename _Scalar> struct FrameForceTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
template <typename _Scalar> struct FrameFrictionConeTpl {
  ...
  FrameFrictionConeTpl(const FrameFrictionConeTpl<Scalar> &value)
      : id(value.id), cone(value.cone) {}
  FrameFrictionConeTpl(const FrameIndex &id, const FrictionCone &cone)
      : id(id), cone(cone) {}
  friend std::ostream &operator<<(std::ostream &os,
...
template <typename _Scalar> struct FrameWrenchConeTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  FrameWrenchConeTpl(const FrameWrenchConeTpl<Scalar> &value)
      : id(value.id), cone(value.cone) {}
...
template <typename _Scalar> struct FrameCoPSupportTpl {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
