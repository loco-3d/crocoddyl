// STATE VECTOR, AND UNICYCLE ACTION MODEL
/* ********************************************************* */
#include <crocoddyl/core/states/state-euclidean.hpp>
#include <crocoddyl/core/actions/unicycle.hpp>


// MAIN SOLVER CLASSES: SHOOTING-PROBLEM, CALLBACKS AND SOLVER-DDP
/* ********************************************************* */
...
int main() {
  ...
  for (unsigned int i = 0; i < T; ++i) {
    ...
    c_end = std::clock();
    duration.push_back(1e3 * (c_end - c_start) / CLOCKS_PER_SEC);
  }
