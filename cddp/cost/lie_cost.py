from cddp.cost import TerminalResidualQuadraticCost, RunningResidualQuadraticCost
import numpy as np
import pinocchio as se3
import math


class SE3TerminalCost(TerminalResidualQuadraticCost):
  """ Terminal cost given a desired SE3 pose of a given frame.
  ...
  def __init__(self, model, ee_frame, M_des):
    """ Construct the terminal cost for a desired SE3 of a given frame.
    ...
    TerminalResidualQuadraticCost.__init__(self, 6)
